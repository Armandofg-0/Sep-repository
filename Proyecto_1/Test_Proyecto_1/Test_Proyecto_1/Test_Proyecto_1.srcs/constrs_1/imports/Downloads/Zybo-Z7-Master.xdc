...
#set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { btn_extra }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
...
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { rgb }]; #IO_L6N_T0_VREF_35 Sch=led6_g
